...
<div id="postmeta">
	<div class="dateline">Updated on <?php echo(date('l, F j, Y')); edit_post_link('<img class="icon" src="' . get_bloginfo('template_directory') . '/images/sanscons/edit.gif" width="16" height="16" alt="Edit this page" />', '&nbsp;&nbsp;'); ?></div>
</div>
